    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DatosBasico>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPerfilNavigation).WithMany(p => p.DatosBasicos)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_datos_basicos_perfil_negocios");
        ...
        modelBuilder.Entity<HistorialCliente>(entity =>
        {
            ...
            entity.HasOne(d => d.IdClienteNavigation).WithMany(p => p.HistorialClientes)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_historial_cliente_clientes");

            entity.HasOne(d => d.IdPedidoNavigation).WithMany(p => p.HistorialClientes)
                .HasForeignKey(d => d.IdPedido)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_historial_cliente_pedidos");
        });
        ...
        modelBuilder.Entity<HistorialProveedore>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPedidoNavigation).WithMany(p => p.HistorialProveedores)
                .HasForeignKey(d => d.IdPedido)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_historial_proveedores_pedidos");

            entity.HasOne(d => d.IdProveedoresNavigation).WithMany(p => p.HistorialProveedores)
                .HasForeignKey(d => d.IdProveedores)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_historial_proveedores_proveedores");
        });
        ...
        modelBuilder.Entity<Pedido>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPerfilNavigation).WithMany(p => p.Pedidos)
                .HasForeignKey(d => d.IdPerfil)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_pedidos_perfil_negocios");
        ...
        {
            entity.HasKey(e => e.IdPerfil).HasName("PK_pefil_negocios");

            entity.ToTable("perfil_negocios");
        ...
        modelBuilder.Entity<Servicio>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPerfilNavigation).WithMany(p => p.Servicios)
                .HasForeignKey(d => d.IdPerfil)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_servicios_perfil_negocios");
        });
